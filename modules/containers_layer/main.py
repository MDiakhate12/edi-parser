...
class ContainersLayer:
    ...
    def compute_containers(
        ...
        used_columns = list(flatten_input_columns.keys())

        # Flatten
        print("Flatten input data")
        df_flatten_renamed = df_flatten[used_columns].rename(columns=flatten_input_columns).query("Container.notnull()")
        ...
        df_containers["is_onboard"] = edi_input_type == "OnBoard"
